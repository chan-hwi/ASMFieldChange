...
public class GlobalStates {
    ...
    private static final Map<String, Object> fieldChange = new HashMap<String, Object>();
    ...
    public static void logFieldChanges(Object instance, String owner) {
        try {
            ...
            for (Field field : fields) {
                ...
                fieldChange.put(fieldName, value);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            Runtime.getRuntime().addShutdownHook(new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        for (Entry<String, Object> entry : fieldChange.entrySet()) {
